...
// var_dump ($_POST);
if(!empty($_POST)){
    $public_key = 'sandbox_i15323255650';
    $private_key = 'sandbox_nsaFYcyZIcqDxBDYI5t0Rz4aURijT4RnO6B9ucDJ';
    $liqpay = new LiqPay($public_key, $private_key);
    $html = $liqpay->cnb_form(array(
        'action'         => 'pay',
        'amount'         =>  $_POST[price_total],
        'currency'       => 'UAH',
        'description'    =>  $_POST[shopping_cart],
        'order_id'       => 'order_id_2',
        'version'        => '3',
        'server_url'     => 'https://marketcenter.com.ua'
    ));
    echo $html;
}
?>
